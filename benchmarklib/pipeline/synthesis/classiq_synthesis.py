...
#from benchmarklib.core import BaseProblem
#from benchmarklib.problems import CliqueProblem
from .synthesizer import Synthesizer, SynthesizerRegistry

logger = logging.getLogger("benchmarklib.pipeline.synthesis.classiq_synthesis")


@SynthesizerRegistry.register
class ClassiqSynthesizer(Synthesizer):
    """
    Classiq Synthesis.
    ...
    def synthesize(self, problem: BaseProblem, **kwargs):
        """
    ...
    def _compile_clique(self, problem: CliqueProblem, **kwargs):
        ...
        self.oracle_qubit = oracle.num_qubits - 1
        logger.warning(
            "PATTERN FOR IDENTIFYING TARGET QUBIT OF CLASSIQ ORACLE HAS NOT BEEN DETERMINED"
        )
